...
``` 
即可建立一个本地服务器。  
![Hugo server](./images/4post/hugoserver.png)  
...
![frontmatter](./images/4post/frontmatter.png)
...
## Stack主题自定义  
首先放一下对比图：  
![lightmode_default](./images/4post/lightmode_default.png)    
...
不过好在 Stack 主题预留了自定义的空间，详见[官网的说明]()。这里具体介绍下自定义的方法：  
...
![选择元素](./images/4post/css_selected.png)  
![文本对应css](./images/4post/css_txt.png)  
可以看到文本被指定为`---body-text-color`。  
再顺藤摸瓜找到对应的颜色控制：  
![颜色css](./images/4post/css_color.png)  
...
![预告](./images/4post/nextepisode.png)
## 预告部分
### 主题配置历程  
### Markdown小教程
